...
public class TestShortestPath {
	public static void main(String[] args) throws Exception {
		// 对文件testG.txt进行读取
//		BufferedReader file = new BufferedReader(new InputStreamReader(new FileInputStream("Graph/bellmanford/testG_negative_circle.txt")));
		BufferedReader file = new BufferedReader(new InputStreamReader(new FileInputStream("Graph/bellmanford/testG1.txt")));
		...
		BellmanFord<Double> bellmanFord = new BellmanFord<>(sparseGraph);
		
		for (int i = 0; i < a[0]; i ++) {
			System.out.println("0 -> " + i + "的最小路径: " + bellmanFord.showShortestPath(i));
			System.out.println("0 -> " + i + "的最小路径的权值: " + bellmanFord.getWeight(i));
			System.out.println();
		}
